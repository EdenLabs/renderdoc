...
static const QString sVSEditorLineCutCopy(QStringLiteral("VisualStudioEditorOperationsLineCutCopyClipboardTag"));
static const QString sWrappedVSEditorLineCutCopy(QStringLiteral("application/x-qt-windows-mime;value=\"VisualStudioEditorOperationsLineCutCopyClipboardTag\""));
